...
def widget_data():
    try:
        sehir = request.args.get('city', 'Istanbul')
        country_code = request.args.get('country', 'TR')
        ...
        next_vakit_key = result.get('sonraki_vakit')
        next_vakit_name = vakit_adlari.get(next_vakit_key, next_vakit_key.capitalize())
        next_vakit_time = result.get('vakit')
        ...
        try:
            ...
            pass # Windows'ta veya locale yoksa sessizce geç
